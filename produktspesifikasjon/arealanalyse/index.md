...
- **language:** `no`
- **SOSI_modellstatus:** `utkast`
- **SOSI_spesifikasjonstype:** `produktspesifikasjon`
- **targetNamespace:** `https://skjema.geonorge.no/SOSI/produktspesifikasjon/GrunnkartArealregnskap\1.0`
- **version:** `1.0`
- **xmlns:** `app`
- **xsdDocument:** `grunnkartArealregnskap`

---

#### Realiseringer fra SOSI - del 1
![iagram med navn Realiseringer fra SOSI- del 1 som viser UML-klasser beskrevet i teksten nedenfor.

---

#### NasjonaltGrunnkartForArealanalyse-20260101
![iagram med navn NasjonaltGrunnkartForArealanalyse-20260101 som viser UML-klasser beskrevet i teksten nedenfor.

---

#### Kodelister
![iagram med navn Kodelister som viser UML-klasser beskrevet i teksten nedenfor.

---

<a id="apparealdekke"></a>
#### «CodeList» Arealdekke
...
##### Profilparametre i tagged values
- **asDictionary:** `true`
- **codeList:** `https://register.geonorge.no/sosi-kodelister/temadata/nasjonalt-grunnkart-for-arealanalyse/arealdekke`

---

<a id="apparealressursgrunnforhold"></a>
...
##### Profilparametre i tagged values
- **asDictionary:** `true`
- **codeList:** `https://register.geonorge.no/sosi-kodelister/fkb/ar5/5.0/arealressursgrunnforhold`

---

<a id="apparealressursskogbonitet"></a>
...
##### Profilparametre i tagged values
- **asDictionary:** `true`
- **codeList:** `https://register.geonorge.no/sosi-kodelister/fkb/ar5/5.0/arealressursskogbonitet`

---

<a id="apphavfiskeribruk"></a>
...
##### Profilparametre i tagged values
- **asDictionary:** `true`
- **codeList:** `https://register.geonorge.no/sosi-kodelister/temadata/nasjonalt-grunnkart-for-arealanalyse/havfiskeribruk`
...
##### Profilparametre i tagged values
- **asDictionary:** `true`
- **codeList:** `https://register.geonorge.no/sosi-kodelister/temadata/nasjonalt-grunnkart-for-arealanalyse/treslag`

---

<a id="apparealregnskap"></a>
...
**område**  
- **Multiplisitet:** `[1..1]`  
- **Type:** `http://skjema.geonorge.no/SOSI/basistype/GM_MultiSurface [GM_MultiSurface]`

**arealdekke**  
- **Multiplisitet:** `[1..1]`  
- **Type:** `<<apparealdekke, «CodeList» Arealdekke>>`
